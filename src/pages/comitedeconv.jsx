            ...
            <section className="mt-40">
                ...
                <article class="sm:mx-[10%]">
                    ...
                    <div className="text-center mx-5">
                        ...
                        <br />
                        <p>
                            El Artículo 58 de la Ley 675 de 2001 señala al Comité de Convivencia como la primera instancia a la que se debe acudir para la solución de conflictos, por ser más expedito, presentando fórmulas y alternativas para dirimirlo. Asimismo, determina que las consideraciones de éste se dejen plasmadas en un acta, que será archivada por el administrador del conjunto y firmada por las partes y por los integrantes del comité; siendo gratuita su colaboración.
                        </p>
