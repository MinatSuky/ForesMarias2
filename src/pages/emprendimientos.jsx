                ...
                <div className="flex gap-y-14 gap-x-10 justify-center mx-4 flex-wrap">
                    {emprendimientos.map((element, index) => (
                        <div key={index} className="w-[450px] border-2 border-[#02519C] rounded-xl shado1 p-4">
                            <p className="font-semibold text-center  nanda">{element.casa}</p>
...
}  /* <div className="w-full flex justify-center" style={{ backgroundImage: `url(${element.foto})`, backgroundSize: 'cover', backgroundPosition: 'center', width: '390px', height: '600px' }} >
    </div> */